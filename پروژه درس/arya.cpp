...
int main()
{
	...
	string prod[100];		// CFG Productions
	string nullprod[100];
	char a[10];
	int n;		//tedade ebarat hA
	int i;
	...
	for (i = 0; i < n; i++)
		cin >> prod[i]; 		// gereftan gerammer ha va vared kardan da araye ee az reshte ha
	...
	for (i = 0; i < l; i++)
		cout << nullprod[i] << endl;		//New Productions Without NULL Productions
	...
	cout << "\n\nThe Wew Productions Without Non Generative Productions Are :-\n";
	for (i = 0; i < l; i++)
		cout << nullprod[i] << endl;
